...
1️⃣하나의 애플리케이션을 마이크로서비스 형태로 나누기

2️⃣각 마이크로서비스마다 독립적인 코드 Repository와 CD 파이프라인 설계

3️⃣매니페스트 작성(Pod 사양, 컨테이너 기동 조건 설정 등)
...
6️⃣인그레스(K8s 클러스터 외부에서의 요청을 K8s 클러스터 내부의 애플리케이션에 연결)

7️⃣부하분산(반복적으로 서비스에 접근하여도 정상작동)
